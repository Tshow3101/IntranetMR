...
namespace IntranetMundoRepresentaciones.Models
{
    ...
    public partial class ModeloMR : DbContext
    {
        ...
        public virtual DbSet<tb_detalleserviciosgenerales> tb_detalleserviciosgenerales { get; set; }
        public virtual DbSet<tb_serviciolineaaerea> tb_serviciolineaaerea { get; set; }
        public virtual DbSet<tb_serviciosgenerales> tb_serviciosgenerales { get; set; }
        public virtual DbSet<tb_servicioshotel> tb_servicioshotel { get; set; }
    }
}
